//
//  HeaderSectionGeneralAlbum.swift
...
class HeaderSectionGeneralAlbum: UICollectionReusableView {
    
    // MARK: - Property
    
    static let identifier = "HeaderSectionGeneralAlbum"
    
    lazy var labelHeader: UILabel = {
        var labelHeader = UILabel()
        labelHeader.font = .boldSystemFont(ofSize: 22)
        labelHeader.text = "Общие альбомы"
