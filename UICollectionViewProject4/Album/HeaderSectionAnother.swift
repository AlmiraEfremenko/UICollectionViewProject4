...
class HeaderSectionAnother: UICollectionReusableView {
    
    // MARK: - Property
    
    static let identifier = "HeaderSectionAnother"
    
    lazy var labelHeader: UILabel = {
        var labelHeader = UILabel()
        labelHeader.font = .boldSystemFont(ofSize: 22)
        labelHeader.text = "Другие медиафайлы"
